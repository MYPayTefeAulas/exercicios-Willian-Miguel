...
import com.example.agenda_3_recyclervieweclique.databinding.ItemContatoBinding

class ContatosAdapter(
    val listaContatos: MutableList<Contatos>,
    ...
    fun swapData(novaListaContatos: List<Contatos>){
        listaContatos.clear()
